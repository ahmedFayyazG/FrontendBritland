...
import { GetTanets, PostTanet, DeleteTanet } from "./apiTanet";
...
const Tanet = () => {
  ...
  const { Name, Address, phoneNumber } = tableitems;
  ...
  return (
    <div>
      <Menu />
      <h2 style={{ margin: "10px", textAlign: "center" }}> Tanets </h2>
      <NavLinks to="/CreateTanet">Add Record</NavLinks>
      {/* {tableitems.map((t, i) => {
